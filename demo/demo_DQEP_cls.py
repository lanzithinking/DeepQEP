"Showcase Deep Q-Exponential Process Classification Model"
...
for i in range(training_iter):
    ...
    sample = output.sample(torch.Size((25,)))
...
plt.savefig('./demo_DQEP_cls_logits.png',bbox_inches='tight')
...
# plt.savefig('./demo_DQEP_cls_probabilities.png',bbox_inches='tight')
...
plt.savefig('./demo_DQEP_cls_boundaries.png',bbox_inches='tight')